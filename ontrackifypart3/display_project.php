...
$projects_query = "SELECT * FROM projects WHERE coordinator_id = ?";
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="evaluate_project.php?project_id=<?php echo $project['id']; ?>" class="btn btn-primary">Evaluate Students</a>
                        </div>
                    </div>
                </div>
            <?php endwhile; ?>
